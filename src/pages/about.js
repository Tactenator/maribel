...
import Main from '../images/maribel1.jpg';
import Left from '../images/maribel2.jpg';
import Right from '../images/maribel3.jpg'
...
const About = () => {
    ...
    return ( 
        <>
            ...
            <div id="aboutUsContainer" className="flex flex-col md:flex-row justify-center p-10 md:p-20 ml-0 md:ml-20 gap-20">
                <div id="photoContainer" className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <img src={Main} alt="Woman throwing a bed sheet" className='col-span-2'></img>
                    <img src={Left} alt="Woman cleaning window while wearing a mask" className='hidden md:grid' ></img>
                    <img src={Right} alt="A person vacuuming up a large amount of confetti" className='hidden md:grid'></img>
                </div>
                <div id="aboutInfo-container" className='md:w-4/5 flex flex-col gap-10 text-center md:text-left'>
                    <h1 className='text-4xl font-Monarda font-bold mb-16'>{language === "English" ? "Who We Are" : "Quien somos"}</h1>
                    <h2 className='text-2xl font-Afterglow md:w-4/5'>
                    ...
                    <h2 className='text-2xl font-Afterglow md:w-3/4 my-5'>
                    ...
                    <h2 className='text-3xl font-Afterglow md:w-3/4 font-bold mb-5'>{language === "English" ? "Our Mission" : "Nuestro Misión"}:</h2>
