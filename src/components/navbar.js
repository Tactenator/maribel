    ...
    return ( 
        <>
            <nav className="flex justify-around items-center pt-6 pb-6 bg-sky-500 text-white md:pl-24 md:pr-24 md:gap-10">
                <h1 className="sm:block text-3xl font-Monarda">Maribel's Cleaning Service</h1>
                ...
                <div ref={mobileRef} id="mobileMenu" className="absolute top-0 left-0 h-[100vh] w-[100vw] z-20 bg-sky-500" style={{display: 'none'}}>
                    ...
                    <ul className="flex flex-col items-center gap-7">
                        <Link className="text-4xl font-Afterglow transition-all duration-200 hover:underline" to="/">Home</Link>
                        <Link className="text-4xl font-Afterglow transition-all duration-200 hover:underline" to="/about">About</Link>
                        <Link className="text-4xl font-Afterglow transition-all duration-200 hover:underline" to="/services">Services</Link>
                        <Link className="text-4xl font-Afterglow transition-all duration-200 hover:underline" to="/contact">Contact</Link>
                    </ul>
                </div>
            </nav>
        </>
