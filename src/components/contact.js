...
const Contact = () => {
    ...
    return ( 
        <div id="contact-container" className="flex flex-col md:flex-row justify-center py-20 px-20 bg-sky-400">
            <div ref={formRef} id="form-container" className="w-full">
                <form name="Contact" method="POST" className="flex flex-col gap-6 items-center" data-netlify="true" onSubmit={((e) => { handleSubmit(e)})}>
